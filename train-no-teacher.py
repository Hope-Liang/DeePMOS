...
def train(num_epochs,
    ...
    while epoch <= num_epochs:
        ...
        if epoch % log_valid == 0:
            ...
            if LCC_student[-1] > best_LCC_student:
                best_LCC_student = LCC_student[-1]
    ...
    _, _, _, _ = valid(model, test_loader, test_set.systems, epoch, 'Test(last)', device, MSE_student, LCC_student, SRCC_student)
    return best_model, model, train_loss, MSE_list, LCC_list, SRCC_list, LCC_student
...
def main():
    ...
    best_model, last_model, train_loss, MSE_list, LCC_list, SRCC_list, LCC_student = train(
