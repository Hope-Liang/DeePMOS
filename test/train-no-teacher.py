...
def train(num_epochs,
    ...
    while epoch <= num_epochs:
        ...
        if epoch % log_valid == 0:
            MSE_student, LCC_student, SRCC_student, sys_SRCC_student = valid(model, dataset, valid_loader, valid_set.systems, epoch, 'Valid(student)', device, MSE_student, LCC_student, SRCC_student)
